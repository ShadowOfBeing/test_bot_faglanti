...
2) Написать на почту собиратора info@sobirator.ru с указанием что за организация, город, информацию по отправке: список фракций, \ 
объём и вес каждой фракции, какого числа хотят отправить. И фото посылок в письмо вложить. \
